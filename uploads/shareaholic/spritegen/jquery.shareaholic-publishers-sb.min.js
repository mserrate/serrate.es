...
c){a.state=="on"&&SHR4P.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey=172809fde4d12743cc4a1ec894142b97f&apitype=3&service=304&link="+encodeURIComponent(a.href)+(c!==""?"&title="+c:""),width:"1",height:"1"}).appendTo("body")}};
...
"</style>"));c.wrap('<div class="shr-7 shareaholic" style="float:left; '+n+' margin:0px 0px 0px 10px !important;"></div>');c.parent().removeClass("shr-7");c.addClass(i);c.addClass(g);SHR4P.debug(c);SHR4P.utils.isMobileBrowser()||c.click(function(a){SHR4P.utils.showServiceLet(o,"twitter");a.preventDefault()});c.attr("data-shr_status","1")}})},trackTweetButtonClick:function(a){a.type="tweet";SHR4P.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey=172809fde4d12743cc4a1ec894142b97f&apitype=3&service=7&link="+
encodeURIComponent(a.target.baseURI)+(a.target.title!==""?"&title="+a.target.title:""),width:"1",height:"1"}).appendTo("body")}};
